    ...
    >
      <div className="py-12">
        <div className=" mx-auto sm:px-6 lg:px-8 flex row">
          ...
          {/*<div className="w-1/3">
            <Button className="primary-tab w-full"
                    onClick={() => getRoute("/Purchases/list")} >Comprar inventario</Button>
            </div>
            */}
        </div>
          ...
          <div className="overflow-hidden shadow-sm sm:rounded-lg">
            ...
            <div id="mySidenav" className="sidenav">
              ...
              <div className="form-container">
                <h3 className="mt-0 text-3xl">Nuevo Artículo</h3>
                <section className="m-auto pb-3">
                  <form onSubmit={submit} encType="multipart/form-data">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      ...
                      <div>
                        <InputLabel htmlFor="barCode" value="Codigo de barra" />
                        <TextInput
                          id="barCode"
                          name="barCode"
                          value={data.barCode}
                      ...
                      <div>
                        <InputLabel htmlFor="stocks" value="Disponibles" />
                        <TextInput
                          id="stocks"
                          name="stocks"
                          value={data.stocks}
                       ...
                       <div>
                        ...
                        <input
                          ...
                          onChange={(e) => {
                            ...
                            const found = icons.find((icon) => regex.test(icon.name));
                            setIconValue(found ? found.value : "");
                          }}
                        />
                        <p>{iconValue}</p>
                        <InputError message={errors.image} className="mt-2" />
                    ...
                    <div className="flex justify-end mt-8">
                      <PrimaryButton
                        className="text-xl btn shadow-md rounded-full my-6 capitalize "
                        disabled={processing}
                      >
                        Crear artículo
                      </PrimaryButton>
                ...
                <div id="card" className="container overflow-hidden">
                  <div className="row">
                    <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                      {items.map((item, index) => (
                        <div key={index} className="bg-fondo p-4 rounded-0 md:rounded-3xl">
                          <div className="w-full">
                            <img src={item.image || ""} alt={item.name} />
                          </div>
                          <div>
                            <h5 className="text-lg font-semibold text-white text-left">{item.name}</h5>
                            <h5 className="text-md font-semibold gray text-left">$ {item.sellingPrice}</h5>
                            <p className="text-sm p-0 m-0 text-muted ellipsis">
                              {item.description}
                            </p>
                          </div>
                          <div className="flex justify-between"></div>
                          <div className="flex items-center gap-4">
                            <p className="text-sm p-0 m-0 text-muted">
                              ({item?.category?.name})
                            </p>
                            <div>
                              <Button onClick={() => openModal(item)}>
            ...
            <Modal show={confirmingItemEdit} onClose={closeModal}>
              ...
              >
                ...
                <div className="flex gap-3">
                  <div className="mt-1 w-1/2">
                    <InputLabel htmlFor="salesUnit" value="Unidad de venta" />
                    <TextInput
                      id="salesUnit"
                      type="text"
                      className="mt-1 block w-full input-primary"
